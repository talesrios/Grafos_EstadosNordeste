...
// public class App {
//     // Siglas para busca e NOMES para exibição conforme o formato solicitado
...
//             System.out.println("SIM, existe um caminho terrestre até " + NOMES[indexY] + ".");
//         else 
//             System.out.println("NÃO, não existe caminho terrestre até " + NOMES[indexY] + ".");
...
//         imprimirOrdemVisita(dfs.getVisitOrder());

//         // QUESTÃO 06
//         System.out.println("[QUESTÃO 06] Ordem de visita na execução da BFS:");
//         imprimirOrdemVisita(bfs.getVisitOrder());
//     }
